...
echo
TIME b "修改 默认IP为 192.168.50.1"
sed -i "s/192.168.1.1/192.168.50.1/g" package/base-files/files/bin/config_generate
TIME b "修改 系统文件..."
curl -fsSL https://raw.githubusercontent.com/back20/patch/main/zzz-default-settings > ./package/lean/default-settings/files/zzz-default-settings
curl -fsSL https://raw.githubusercontent.com/back20/patch/main/x86_index.htm > ./package/lean/autocore/files/x86/index.htm
curl -fsSL https://raw.githubusercontent.com/back20/patch/main/smb.conf.template > ./feeds/packages/net/samba4/files/smb.conf.template
...
echo
TIME y "添加 Pass wall"
git clone https://github.com/xiaorouji/openwrt-passwall package/back20/passwall && git clone -b luci https://github.com/xiaorouji/openwrt-passwall && mv openwrt-passwall/luci-app-passwall package/back20/passwall && rm -rf openwrt-passwall
echo
TIME y "添加 Pass wall2"
git clone https://github.com/xiaorouji/openwrt-passwall2 package/back20/passwall2
sed -i '16a entry({"admin", "vpn"}, firstchild(), "GFW", 45).dependent = false' package/back20/passwall2/luci-app-passwall2/luasrc/controller/passwall2.lua
echo
...
curl -fsSL https://raw.githubusercontent.com/back20/patch/main/mwan3helper_status.htm > ./feeds/luci/applications/luci-app-mwan3helper/luasrc/view/mwan3helper/mwan3helper_status.htm
...
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/controller/*.lua
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/api/*.lua
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/client/*.lua
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/server/*.lua
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/model/cbi/passwall2/server/api/*.lua
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/view/passwall2/app_update/*.htm
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/view/passwall2/auto_switch/*.htm
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/view/passwall2/global/*.htm
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/view/passwall2/log/*.htm
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/view/passwall2/node_list/*.htm
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/view/passwall2/rule/*.htm
sed -i 's/services/vpn/g' package/back20/passwall2/luci-app-passwall2/luasrc/view/passwall2/server/*.htm
...
echo
TIME y "更新固件 编译日期"
sed -i "s/2023.01.16/$(TZ=UTC-8 date "+%Y.%m.%d")/g" package/lean/autocore/files/x86/index.htm
#echo 
#TIME y "更换5.4内核"
